...
| -------------------------------- | ------ | ----------------------------------------- |
| 1. Authentication                | ❌ 0/6 | _auth.setup.ts (setup only, no UX tests)_ |
...
| 15. Footer / Error UX            | ❌ 0/4 | _not started_                             |
| 16. Responsiveness               | ❌ 0/4 | _not started_                             |
| 17. Smoke Test                   | ❌ 0/1 | _not started_                             |
