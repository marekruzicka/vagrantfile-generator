...
class OIDCService:
    ...
    def _register_providers(self):
        ...
        if google_client_id and google_client_secret:
            ...
            logger.warning("Google OAuth not configured - OIDC_GOOGLE_CLIENT_ID/SECRET not set")
        ...
        if github_client_id and github_client_secret:
            ...
            logger.warning("GitHub OAuth not configured - OIDC_GITHUB_CLIENT_ID/SECRET not set")
        ...
        if gitlab_client_id and gitlab_client_secret:
            ...
            logger.warning("GitLab OAuth not configured - OIDC_GITLAB_CLIENT_ID/SECRET not set")
