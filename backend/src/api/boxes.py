...
async def get_box(box_id: str, box_service: BoxService = Depends(get_box_service)):
...
async def create_box(
    box_data: BoxCreate, box_service: BoxService = Depends(get_box_service)
):
    # Create a new box.
    try:
...
async def update_box(
    box_id: str, box_data: BoxUpdate, box_service: BoxService = Depends(get_box_service)
):
...
async def delete_box(box_id: str, box_service: BoxService = Depends(get_box_service)):
    # Delete a box.
    try:
...
async def copy_shared_box(
    box_id: str, box_service: BoxService = Depends(get_box_service)
):
    """
...
async def get_copies_of_shared_box(
    source_id: str, box_service: BoxService = Depends(get_box_service)
):
    """
